...
These commands will ask you to select a CRAN server. Any server will do. You may
...
time you want to use **optmatch** or
**[RItools](https://cran.r-project.org/package=RItools)** on a particular
computer, or when you install a new version of *R*.
...
`xBalance` function zeroes in on balance, and facilitates checking balance on
...
will call `xBalance` in the background, reporting the summary chi-square test
results.
