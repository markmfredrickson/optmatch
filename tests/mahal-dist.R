...
match_on(pr ~ date + cum.n, data = nuclear, exclusions = exactMatch(pr ~ pt, data = nuclear))
...
match_on(pr ~ date + cum.n.q, data = nuclear, exclusions = exactMatch(pr~pt, data = nuclear))
