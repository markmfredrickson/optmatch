...
C     LOGICAL*1 SCAN(MAXNN),MARK(MAXNN)
      LOGICAL*1 REPEAT
...
C
C
      SUBROUTINE RELAX4(STARTN, ENDN, FOU, NXTOU, FIN, NXTIN, RC, U, DFCT, X)
      IMPLICIT INTEGER (A-Z)
C
C---------------------------------------------------------------
C
...
c     INTEGER I15(MAXNN),I16(MAXNN),I17(MAXNN)
      LOGICAL*1, ALLOCATABLE:: SCAN(:), MARK(:)
C     LOGICAL*1 SCAN(MAXNN),MARK(MAXNN)
...
C     ALLOCATE THE ARRAYS
      ALLOCATE (LABEL(N), PRDCSR(N), SAVE(NA))
...
C
      IF (POSIT) THEN
        CALL ASCNT1(DM, DELX, NLABEL, FEASBL, SWITCH, NSCAN, NODE,
     $    PREVNODE, STARTN, ENDN, FOU, NXTOU, FIN, NXTIN, RC, U, X,
     $    DFCT, LABEL, PRDCSR, TFSTOU, TNXTOU, TFSTIN, TNXTIN, NXTQUEUE,
     $    SCAN, MARK)
C       CALL ASCNT1(DM,DELX,NLABEL,FEASBL,
C    $  SWITCH,NSCAN,NODE,PREVNODE)
        NUM_ASCNT=NUM_ASCNT+1
      ELSE
        CALL ASCNT2(DM, DELX, NLABEL, FEASBL, SWITCH, NSCAN, NODE,
     $    PREVNODE, STARTN, ENDN, FOU, NXTOU, FIN, NXTIN, RC, U, X,
     $    DFCT, LABEL, PRDCSR, TFSTOU, TNXTOU, TFSTIN, TNXTIN, NXTQUEUE,
     $    SCAN, MARK)
...
C      
C
      SUBROUTINE AUCTION(STARTN, ENDN, FOU, NXTOU, FIN, NXTIN, RC, U, X, DFCT)
      IMPLICIT INTEGER (A-Z)
C
C---------------------------------------------------------------
C 
...
C     INTEGER SB_LEVEL(MAXNN),SB_ARC(MAXNN)
      LOGICAL*1, ALLOCATABLE:: PATH_ID(:)
C     LOGICAL*1 PATH_ID(MAXNN)
...
C
C
      SUBROUTINE ASCNT1(DM, DELX, NLABEL, FEASBL, SWITCH, NSCAN, CURNODE, PREVNODE,
     $ STARTN, ENDN, FOU, NXTOU, FIN, NXTIN, RC, U, X, DFCT,
     $ LABEL, PRDCSR, TFSTOU, TNXTOU, TFSTIN, TNXTIN, NXTQUEUE, SCAN, MARK)
...
C
C
      SUBROUTINE ASCNT2(DM, DELX, NLABEL, FEASBL, SWITCH, NSCAN, CURNODE, PREVNODE,
     $ STARTN, ENDN, FOU, NXTOU, FIN, NXTIN, RC, U, X, DFCT,
     $ LABEL, PRDCSR, TFSTOU, TNXTOU, TFSTIN, TNXTIN, NXTQUEUE, SCAN, MARK)
