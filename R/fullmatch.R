...
fullmatch <- function(distance,
  ...
  # if the distance matrix doesn't have correct names, give it some defaults (to allow better handling later)
  if(is.null(names(problems))) names(problems) <- 1:length(problems)
