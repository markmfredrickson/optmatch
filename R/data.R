...
#' \itemize{
#'   \item cost: The capital cost of construction in millions of dollars adjusted to 1976 base.
#'   \item date: The date on which the construction permit was issued.  The data are measured in
#' years since January 1 1990 to the nearest month.
#'   \item t1: The time between application for and issue of the construction permit.
#'   \item t2: The time between issue of operating license and construction permit.
#'   \item cap: The net capacity of the power plant (MWe).
#'   \item pr: A binary variable where \code{1} indicates the prior existence of a LWR plant at
#' the same site.
#'   \item ne: A binary variable where \code{1} indicates that the plant was constructed in the
#' north-east region of the U.S.A.
#'   \item ct: A binary variable where \code{1} indicates the use of a cooling tower in the plant.
#'   \item bw: A binary variable where \code{1} indicates that the nuclear steam supply system was
#' manufactured by Babcock-Wilcox.
#'   \item cum.n: The cumulative number of power plants constructed by each architect-engineer.
#'   \item pt: A binary variable where \code{1} indicates those plants with partial turnkey
#' guarantees.
#' }
#' @source Cox, D.R. and Snell, E.J. (1981) \emph{Applied Statistics: Principles and Examples}. Chapman and Hall.
"nuclearplants"
...
#' \emph{Applied Statistics: Principles and Examples}, p.82  (Chapman and
#' Hall), and are due to W.E. Mooz.
#'
#' @format A matrix with 7 rows and 19 columns
#' @source Rosenbaum, P.R. (2002), \emph{Observational Studies}, Second Edition, p.307 (Springer).
"plantdist"
